...
class TripleInputConv(nn.Module):
    ...
    Supports loading pretrained weights from standard YOLOv26 models by replicating the first layer weights
    ...
    def __init__(self, c1, c2, k=3, s=1, p=None, g=1, d=1, act=True, pretrained_weights=None):
        ...
        Args:
            ...
            pretrained_weights: Optional pretrained weights from standard YOLOv26 first layer
        """
        super().__init__()
    ...
    def load_pretrained_weights(self, pretrained_state_dict):
        """
        Load pretrained weights from a standard YOLOv26 model.
        
        Args:
            pretrained_state_dict: State dict from pretrained YOLOv26 model
        """
        try:
    ...
    def from_pretrained(cls, c1, c2, pretrained_model_path, **kwargs):
        ...
        Args:
            ...
            c2: Output channels
            pretrained_model_path: Path to pretrained YOLOv26 model (.pt file)
