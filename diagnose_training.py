#!/usr/bin/env python3
"""
Diagnostic script to identify training issues with YOLOv26 Triple Input DINOv3 model.
"""
...
def diagnose_training_issues(data_config_path: str, model_config_path: str):
    ...
    print("🔍 YOLOv26 Triple DINOv3 Training Diagnostics")
    print("=" * 60)
...
if __name__ == "__main__":
    ...
    model_config = "ultralytics/cfg/models/v26/yolov26_triple_dinov3.yaml"
