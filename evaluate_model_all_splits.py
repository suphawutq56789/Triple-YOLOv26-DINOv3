#!/usr/bin/env python3
"""
Comprehensive model evaluation script for YOLOv26 Triple Input models.

This script evaluates trained models on train, validation, and test splits
and provides a comprehensive mAP report.

Usage:
    python evaluate_model_all_splits.py --model runs/detect/yolov26_triple_dinov3/weights/best.pt --data test_triple_dataset.yaml
    python evaluate_model_all_splits.py --model runs/detect/yolov26_triple_dinov3/weights/best.pt --data test_triple_dataset.yaml --splits val test
"""
...
def evaluate_model_on_splits(model_path, data_config, splits=['train', 'val', 'test'], device='0'):
    ...
    print("YOLOv26 Triple Input Model Evaluation")
    print("=" * 60)
...
def main():
    parser = argparse.ArgumentParser(
        description='Evaluate YOLOv26 Triple Input model on multiple data splits',
