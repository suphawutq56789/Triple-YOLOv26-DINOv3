...
Usage:
    ...
    python train_triple_dinov3.py --data test_triple_dataset.yaml --pretrained yolov26n.pt --dinov3-size small
"""
...
def train_triple_dinov3(
    ...
    patience: int = 50,
    name: str = "yolov26_triple_dinov3",
    device: str = "0",
    integrate: str = "initial",  # New parameter: "initial", "nodino", "p3"
    variant: str = "s",  # YOLOv26 model variant: n, s, m, l, x
    ...
    **kwargs
    ...
    Args:
        ...
        variant: YOLOv26 model variant (n, s, m, l, x)
    ...
    print("YOLOv26 Triple Input with DINOv3 Training")
    print("=" * 60)
    ...
    if integrate == "nodino":
        ...
        model_config = "ultralytics/cfg/models/v26/yolov26_triple_dinov3_p0_only.yaml"
        print("Using DINOv3 P0-only preprocessing integration (input preprocessing before backbone)")
    elif integrate == "p3":
        model_config = "ultralytics/cfg/models/v26/yolov26_triple_dinov3_p3.yaml"
        print("Using DINOv3 integration after P3 stage")
    elif integrate == "p0p3":
        model_config = "ultralytics/cfg/models/v26/yolov26_triple_dinov3_p0p3_adapter.yaml"
    ...
    try:
        if pretrained_path:
            ...
            if integrate == "nodino":
                ...
                temp_config_path = f"temp_yolov26_triple_nodino_{variant}.yaml"
                ...
                temp_config_path = f"temp_yolov26_triple_dinov3_{variant}_{dinov3_size}.yaml"
                with open(temp_config_path, 'w') as f:
                    yaml.dump(config, f, default_flow_style=False)
...
def compare_with_without_dinov3(data_config: str, epochs: int = 50):
    ...
    """
    print("Comparing YOLOv26 Triple Input with and without DINOv3")
    print("=" * 70)
...
def main():
    ...
    parser.add_argument('--name', type=str, default='yolov26_triple_dinov3',
                       help='Experiment name (default: yolov26_triple_dinov3)')
    parser.add_argument('--device', type=str, default='cpu',
                       help='Device to use (default: cpu, use "0" for GPU)')
    parser.add_argument('--variant', type=str, choices=['n', 's', 'm', 'l', 'x'], default='s',
                       help='YOLOv26 model variant (default: s)')
