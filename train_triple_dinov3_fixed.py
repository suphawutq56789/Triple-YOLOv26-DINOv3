#!/usr/bin/env python3
"""
Fixed training script for YOLOv26 Triple Input with DINOv3 backbone.
...
def train_triple_dinov3_fixed(
    ...
    **kwargs
    ...
    print("YOLOv26 Triple Input Training (Fixed for Triple Input Datasets)")
    print("=" * 70)
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Train YOLOv26 Triple Input with DINOv3 backbone (FIXED for Triple Input Datasets)',
    ...
    parser.add_argument('--name', type=str, default='yolov26_triple_dinov3_fixed',
                       help='Experiment name (default: yolov26_triple_dinov3_fixed)')
