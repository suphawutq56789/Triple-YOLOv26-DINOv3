...
the environment for YOLOv26 Triple Input integration.
...
class DINOv3Downloader:
    ...
    def __init__(self, cache_dir: str = None):
        ...
        """
        self.cache_dir = Path(cache_dir) if cache_dir else Path.home() / ".cache" / "yolov26_dinov3"
    ...
    def test_integration(self, model_size: str = "small"):
        """
        Test DINOv3 integration with YOLOv26 Triple Input.
...
def main():
    parser = argparse.ArgumentParser(description='Download and setup DINOv3 models for YOLOv26 Triple Input')
    ...
    print("You can now use DINOv3 backbones in your YOLOv26 Triple Input models.")
