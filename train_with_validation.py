#!/usr/bin/env python3
"""
Training Script for YOLOv26 Triple Input with Proper Train/Val/Test Split
...
Usage:
    python train_with_validation.py --model ultralytics/cfg/models/v26/yolov26_triple.yaml --data test_triple_dataset.yaml
"""
...
def train_model(model_config, data_config, epochs=100, batch_size=16, imgsz=640, 
                patience=50, save_period=10, name="yolov26_triple_training"):
    """
    Train YOLOv26 model with triple input support.
    ...
    print("Starting YOLOv26 Triple Input Training")
    print("-" * 50)
...
def main():
    parser = argparse.ArgumentParser(description='Train YOLOv26 Triple Input model')
    parser.add_argument('--model', type=str, required=True,
                       help='Path to model configuration file (e.g., ultralytics/cfg/models/v26/yolov26_triple.yaml)')
    ...
    parser.add_argument('--name', type=str, default='yolov26_triple_training',
                       help='Experiment name (default: yolov26_triple_training)')
